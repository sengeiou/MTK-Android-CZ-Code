...
public final class ReviewPermissionsFragment extends PreferenceFragment
    ...
    private static final String TAG = "ReviewPermissionsFragment";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (UtilsExt.sCtaManager.isCtaSupported()) {
            UtilsExt.initPermStateCache(mAppPermissions, null);
        }
        ///@}
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        Log.d(TAG,"-------onPreferenceChange " + mHasConfirmedRevoke);
        if (mHasConfirmedRevoke) {
            /// M: Pre-grant permissions in review UI @{
            if (UtilsExt.sCtaManager.isCtaSupported()) {
                UtilsExt.setPermGroupStateCache(mAppPermissions,preference.getKey(),
        ...
        if (preference instanceof SwitchPreference) {
            ...
            if (switchPreference.isChecked()) {
                ...
                /// M: Pre-grant permissions in review UI @{
                if (UtilsExt.sCtaManager.isCtaSupported()) {
                    UtilsExt.setPermGroupStateCache(mAppPermissions,preference.getKey(), true);
                }
                ///@}
                return true;
            }
    ...
    public void onActionConfirmed(String action) {
        ...
        if (preference instanceof SwitchPreference) {
            ...
            if(UtilsExt.sCtaManager.isCtaSupported()) {
               UtilsExt.setPermGroupStateCache(mAppPermissions,preference.getKey(), false);
            }
        }
    }
                ...
                /// M: CTA requirement - permission control @{
                    ...
                    for (int j = 0; j < permissionCount; j++) {
                        ...
                        boolean grant = UtilsExt.isPermGrantedByCache(permission);
                            Log.d(TAG,"-------isPermGrantedByCache--------"
    ...
    private void bindUi() {
        ...
        //M: change button text if cta enable
        if (UtilsExt.sCtaManager.isCtaSupported()) {
    ...
    private void loadPreferences() {
        ...
        for (AppPermissionGroup group : mAppPermissions.getPermissionGroups()) {
                /// M: CTA requirement - permission control @{
                if (!Utils.
                        shouldShowPermission(group, mAppPermissions.getPackageInfo().packageName)
                    || !UtilsExt.sCtaManager.
            ...
            /// M: CTA requirement - permission control @{
            if (UtilsExt.sCtaManager.isCtaSupported()) {
                preference.setChecked(UtilsExt.isPermGroupGrantedByCache(group));
            /// }@
            } else {
