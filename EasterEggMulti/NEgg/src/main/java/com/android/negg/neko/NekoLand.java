...
import com.android.negg.R;
import com.android.negg.neko.PrefState.PrefsListener;
    ...
    private void shareCat(Cat cat) {
        ...
        if (bitmap != null) {
            try {
                ...
                Uri uri = FileProvider.getUriForFile(this, "com.android.pegg.fileprovider", png);
