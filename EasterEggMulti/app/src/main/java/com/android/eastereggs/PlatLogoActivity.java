...
public class PlatLogoActivity extends Activity {
    ...
    /*
        pjz@ubuntu:~/android8.1/phone8/6737_oreo/alps/frameworks$ find -name "*.xml" | xargs grep "category.PLATLOGO"
            ./base/packages/EasterEgg/AndroidManifest.xml:                <category android:name="com.android.internal.category.PLATLOGO" />
