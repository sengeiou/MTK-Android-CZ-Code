...
public class SignalTileView extends QSIconViewImpl {
    ...
    public void setIcon(QSTile.State state) {
        ...
        //20190822 pjz add show signalicon stay with statusicon
        Log.e("cczz", " value="+s.value);
        mIn.setVisibility(s.value ? VISIBLE : GONE);
        mOut.setVisibility(s.value ? VISIBLE : GONE);

        /*final boolean shown = isShown();
        Log.e("cczz", "shown="+shown + " activityIn="+s.activityIn+" activityOut="+s.activityOut);
