...
class WifiIcons {
   ...
   //      };
    static final int[][] WIFI_SIGNAL_STRENGTH = {
            { R.drawable.stat_sys_wifi_signal_0_new,
              R.drawable.stat_sys_wifi_signal_1_new,
              R.drawable.stat_sys_wifi_signal_2_new,
              R.drawable.stat_sys_wifi_signal_3_new,
              R.drawable.stat_sys_wifi_signal_4_new },
            { R.drawable.stat_sys_wifi_signal_0_fully_new,
              R.drawable.stat_sys_wifi_signal_1_fully_new,
              R.drawable.stat_sys_wifi_signal_2_fully_new,
              R.drawable.stat_sys_wifi_signal_3_fully_new,
              R.drawable.stat_sys_wifi_signal_4_fully_new }
        };
    ...
    static final int[][] WIFI_SIGNAL_STRENGTH_INOUT = {
        ...
        { R.drawable.stat_sys_wifi_signal_1_fully,
          R.drawable.stat_sys_wifi_signal_1_in_new,
          R.drawable.stat_sys_wifi_signal_1_out_new,
          R.drawable.stat_sys_wifi_signal_1_inout_new },

        { R.drawable.stat_sys_wifi_signal_2_fully,
          R.drawable.stat_sys_wifi_signal_2_in_new,
          R.drawable.stat_sys_wifi_signal_2_out_new,
          R.drawable.stat_sys_wifi_signal_2_inout_new },

        { R.drawable.stat_sys_wifi_signal_3_fully,
          R.drawable.stat_sys_wifi_signal_3_in_new,
          R.drawable.stat_sys_wifi_signal_3_out_new,
          R.drawable.stat_sys_wifi_signal_3_inout_new },

        { R.drawable.stat_sys_wifi_signal_4_fully,
          R.drawable.stat_sys_wifi_signal_4_in_new,
          R.drawable.stat_sys_wifi_signal_4_out_new,
          R.drawable.stat_sys_wifi_signal_4_inout_new }
    };
    /// @ }
}
