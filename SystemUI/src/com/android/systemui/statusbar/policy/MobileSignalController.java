...
public class MobileSignalController extends SignalController<
    ...
    public MobileSignalController(Context context, Config config, boolean hasMobileData,
        ...
        telecommMgr = (TelecomManager) context.getSystemService(Context.TELECOM_SERVICE);
    }
    ...
    private int getVolteIcon() {
        ...
        if (isImsOverWfc()) {
            ...
            if (mCurrentState.imsRegState == ServiceState.STATE_IN_SERVICE) {
                ...
                Log.d("ccz", "volte icon has get " + icon);
        ...
        /// M: add for check volte is available
        if (!isVideoCallingAvailability()) {
            icon = 0;
        }
        /// @}
    ...
    private  boolean isVideoCallingAvailability() {
        if (telecommMgr == null) {
            return false;
        }
        ...
        for (PhoneAccountHandle accountHandle : accountHandles) {
            ...
            if (account != null) {
                if (account.hasCapabilities(PhoneAccount.CAPABILITY_VIDEO_CALLING)) {
                    Log.e("ccz", "hasCapabilities PhoneAccount.CAPABILITY_VIDEO_CALLING");
                    return true;
                }
            }
        }
    ...
    public void notifyListeners(SignalCallback callback) {
        ...
        if (mCurrentState.connected) {
            //20190510 pjz add get signal icon  [S]
            ...
            //20190510 pjz add get signal icon  [E]
        }else{
        ...
        /// @ }
        //20190510 pjz add  for when datadisable set mMobileDataActivity GONE [S]
        if (isDataDisabled()) {
            typeIcon = 0;
        }
        Log.d("ccz", "qsTypeIcon="+qsTypeIcon);
        //20190510 pjz add  for when datadisable set mMobileDataActivity GONE [E]
    ...
    static class MobileState extends SignalController.State {
        ...
        public boolean equals(Object o) {
            return super.equals(o)
                    ...
                    && ((MobileState) o).operator == operator
                    && ((MobileState) o).mQsDataType == mQsDataType
                    /// M: Add for data network type.
