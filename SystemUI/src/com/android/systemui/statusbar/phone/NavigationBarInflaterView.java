...
public class NavigationBarInflaterView extends FrameLayout
    ...
    public NavigationBarInflaterView(Context context, AttributeSet attrs) {
        ...
        Log.i(TAG, "PhysicalWidth="+displayMode.getPhysicalWidth() + " PhysicalHeight="+displayMode.getPhysicalHeight());
        Log.e(TAG, "isRot0Landscape="+isRot0Landscape);
        //isRot0Landscape = false;
    }
    ...
    private void updateAlternativeOrder() {
        Log.e("cct","updateAlternativeOrder()");
    ...
    private View applySize(View v, String buttonSpec, boolean landscape, boolean start) {
        ...
        Log.i(TAG, "buttonSpec="+buttonSpec +"  sizeStr="+sizeStr);
        Log.e(TAG, "WEIGHT_SUFFIX="+WEIGHT_SUFFIX);
    ...
    private View createView(String buttonSpec, ViewGroup parent, LayoutInflater inflater) {
        ...
        if (LEFT.equals(button)) {
            //pjz change NAVSPACE to MENU_IME for small left back click area
            String s = Dependency.get(TunerService.class).getValue(NAV_BAR_LEFT, MENU_IME/*NAVSPACE*/);
