...
public class NavigationBarView extends FrameLayout implements PluginListener<NavGesture> {
    ...
    public void setDisabledFlags(int disabledFlags, boolean force) {
        ...
        if (inLockTask() && disableRecent && !disableHome) {
         ...
         Log.i("cct","disableBack="+disableBack + " disableHome=="+disableHome + " disableRecent="+disableRecent);
    ...
    private void updateCurrentView() {
        //pjz set display rot = 1
        final int rot = mDisplay.getRotation();
        Log.i("cct","ROTATION_0="+Surface.ROTATION_0+"  ROTATION_180="+Surface.ROTATION_180 +
            "   ROTATION_90="+Surface.ROTATION_90+"  ROTATION_270="+Surface.ROTATION_270);
        Log.i("cct","rot="+rot + " rotation=="+mDisplay.getRotation());
    ...
    public void reorient() {
        Log.d("cct","reorient-->updateCurrentView()");
        updateCurrentView();
